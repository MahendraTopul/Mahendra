...
window = tk.TK()
window.title(f"Text Editor Application")
...
btncopy = tk.Button(window,width=8,text="copy", command= copy).place(x=2,y=80)
btncut = tk.Button(window,width=8,text="cut", command= cut).place(x=2,y=100)
btnpaste = tk.Button(window,width=8,text="paste", command= paste).place(x=2,y=120)
